...
// ImageInfo represents the full IMAGE_INFO section structure using annotations
...
func (i *ImageInfo) UnmarshalWithReserved(data []byte) error {
	...
	return annotations.UnmarshalWithOptionsStruct(data, i, opts)
}
...
func (i *ImageInfo) MarshalWithReserved() ([]byte, error) {
	...
	return annotations.MarshalWithOptionsStruct(i, opts)
}
