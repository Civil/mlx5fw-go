...
func GetSectionTypeByName(name string) uint16 {
	...
	nameToType := map[string]uint16{
		"BOOT_CODE":                 SectionTypeBootCode,
		"PCI_CODE":                  SectionTypePCICode,
		"MAIN_CODE":                 SectionTypeMainCode,
		"PCIE_LINK_CODE":            SectionTypePCIELinkCode,
		"IRON_PREP_CODE":            SectionTypeIronPrepCode,
		"POST_IRON_BOOT_CODE":       SectionTypePostIronBootCode,
		"UPGRADE_CODE":              SectionTypeUpgradeCode,
		"HW_BOOT_CFG":               SectionTypeHWBootCfg,
		"HW_MAIN_CFG":               SectionTypeHWMainCfg,
		"PHY_UC_CODE":               SectionTypePhyUCCode,
		"PHY_UC_CONSTS":             SectionTypePhyUCConsts,
		"PCIE_PHY_UC_CODE":          SectionTypePCIEPhyUCCode,
		"CCIR_INFRA_CODE":           SectionTypeCCIRInfraCode,
		"CCIR_ALGO_CODE":            SectionTypeCCIRAlgoCode,
		"BOOT3_CODE":                SectionTypeBoot3Code,
		"IMAGE_INFO":                SectionTypeImageInfo,
		"FW_BOOT_CFG":               SectionTypeFWBootCfg,
		"FW_MAIN_CFG":               SectionTypeFWMainCfg,
		"APU_KERNEL":                SectionTypeAPUKernel,
		"ACE_CODE":                  SectionTypeACECode,
		"ROM_CODE":                  SectionTypeROMCode,
		"RESET_INFO":                SectionTypeResetInfo,
		"DBG_FW_INI":                SectionTypeDbgFWINI,
		"DBG_FW_PARAMS":             SectionTypeDbgFWParams,
		"FW_ADB":                    SectionTypeFWAdb,
		"IMAGE_SIGNATURE_256":       SectionTypeImageSignature256,
		"PUBLIC_KEYS_2048":          SectionTypePublicKeys2048,
		"FORBIDDEN_VERSIONS":        SectionTypeForbiddenVersions,
		"IMAGE_SIGNATURE_512":       SectionTypeImageSignature512,
		"PUBLIC_KEYS_4096":          SectionTypePublicKeys4096,
		"HMAC_DIGEST":               SectionTypeHMACDigest,
		"RSA_PUBLIC_KEY":            SectionTypeRsaPublicKey,
		"RSA_4096_SIGNATURES":       SectionTypeRsa4096Signatures,
		"ENCRYPTION_KEY_TRANSITION": SectionTypeEncryptionKeyTransition,
		"PXIR_INI":                  SectionTypePxirIni,
		"PXIR_INI1":                 SectionTypePxirIni1,
		"NVDA_ROT_CERTIFICATES":     SectionTypeNvdaRotCertificates,
		"EXCLKSYNC_INFO":            SectionTypeExclkSyncInfo,
		"MAIN_PAGES_HASHES":         SectionTypeMainPagesHashes,
		"MAIN_PAGES_LOCKED_HASHES":  SectionTypeMainPagesLockedHashes,
		"STRN_MAIN":                 SectionTypeStrnMain,
		"STRN_IRON":                 SectionTypeStrnIron,
		"STRN_TILE":                 SectionTypeStrnTile,
		"MAIN_DATA":                 SectionTypeMainData,
		"FW_DEBUG_DUMP_2":           SectionTypeFwDebugDump2,
		"SECURITY_LOG":              SectionTypeSecurityLog,
		"MFG_INFO":                  SectionTypeMfgInfo,
		"DEV_INFO":                  SectionTypeDevInfo,
		"NV_DATA":                   SectionTypeNvData1,
		"VPD_R0":                    SectionTypeVpdR0,
		"FW_NV_LOG":                 SectionTypeFwNvLog,
		"CRDUMP_MASK_DATA":          SectionTypeCRDumpMaskData,
		"FW_INTERNAL_USAGE":         SectionTypeFwInternalUsage,
		"PROGRAMMABLE_HW_FW":        SectionTypeProgrammableHwFw1,
		"DIGITAL_CERT_PTR":          SectionTypeDigitalCertPtr,
		"DIGITAL_CERT_RW":           SectionTypeDigitalCertRw,
		"LC_INI1_TABLE":             SectionTypeLcIni1Table,
		"LC_INI2_TABLE":             SectionTypeLcIni2Table,
		"LC_INI_NV_DATA":            SectionTypeLcIniNvData,
		"CERT_CHAIN_0":              SectionTypeCertChain0,
		"DIGITAL_CACERT_RW":         SectionTypeDigitalCaCertRw,
		"CERTIFICATE_CHAINS_1":      SectionTypeCertificateChains1,
		"CERTIFICATE_CHAINS_2":      SectionTypeCertificateChains2,
		"ROOT_CERTIFICATES_1":       SectionTypeRootCertificates1,
		"ROOT_CERTIFICATES_2":       SectionTypeRootCertificates2,
		"TOOLS_AREA":                SectionTypeToolsArea,
		"HASHES_TABLE":              SectionTypeHashesTable,
		"HW_PTR":                    SectionTypeHwPtr,
		"FW_DEBUG_DUMP":             SectionTypeFwDebugDump,
		"ITOC":                      SectionTypeItoc,
		"DTOC":                      SectionTypeDtoc,
		"END":                       SectionTypeEnd,
		"BOOT2":                     SectionTypeBoot2,
	}

	if sectionType, ok := nameToType[name]; ok {
		return sectionType
	}
