...
// BinaryVersionAnnotated represents the binary version structure used in Tools Area
// Based on tools_binary_header from mstflint
type BinaryVersionAnnotated struct {
...
// ToolsAreaAnnotated represents the tools area header structure
type ToolsAreaAnnotated struct {
	BinaryHeader BinaryVersion `offset:"byte:0"`
	// Data follows - variable length
}

// MagicPatternStructAnnotated represents the firmware magic pattern structure
// This is found at various offsets in the firmware image
type MagicPatternStructAnnotated struct {
...
// Boot2HeaderAnnotated represents the Boot2 section header
type Boot2HeaderAnnotated struct {
...
// HWIDRecordAnnotated represents a hardware ID record
// Used for device identification
type HWIDRecordAnnotated struct {
...
func (b *BinaryVersionAnnotated) Unmarshal(data []byte) error {
	return annotations.UnmarshalStruct(data, b)
}

// Marshal marshals the annotated structure into binary data
func (b *BinaryVersionAnnotated) Marshal() ([]byte, error) {
	return annotations.MarshalStruct(b)
}

// Unmarshal unmarshals binary data into the annotated structure
func (t *ToolsAreaAnnotated) Unmarshal(data []byte) error {
	return annotations.UnmarshalStruct(data, t)
}

// Marshal marshals the annotated structure into binary data
func (t *ToolsAreaAnnotated) Marshal() ([]byte, error) {
	return annotations.MarshalStruct(t)
}

// Unmarshal unmarshals binary data into the annotated structure
func (m *MagicPatternStructAnnotated) Unmarshal(data []byte) error {
	return annotations.UnmarshalStruct(data, m)
}

// Marshal marshals the annotated structure into binary data
func (m *MagicPatternStructAnnotated) Marshal() ([]byte, error) {
	return annotations.MarshalStruct(m)
}

// Unmarshal unmarshals binary data into the annotated structure
func (b *Boot2HeaderAnnotated) Unmarshal(data []byte) error {
	return annotations.UnmarshalStruct(data, b)
}

// Marshal marshals the annotated structure into binary data
func (b *Boot2HeaderAnnotated) Marshal() ([]byte, error) {
	return annotations.MarshalStruct(b)
}

// Unmarshal unmarshals binary data into the annotated structure
func (h *HWIDRecordAnnotated) Unmarshal(data []byte) error {
	return annotations.UnmarshalStruct(data, h)
}

// Marshal marshals the annotated structure into binary data
func (h *HWIDRecordAnnotated) Marshal() ([]byte, error) {
